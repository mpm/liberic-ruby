module Liberic
  ...
  def check_eric_version!
    ...
    if eric_version != SDK::Configuration::LIBERICAPI_VERSION
      raise InitializationError.new("ERiC #{SDK::Configuration::LIBERICAPI_VERSION} required, but #{eric_version} found.")
    end
  end
end
